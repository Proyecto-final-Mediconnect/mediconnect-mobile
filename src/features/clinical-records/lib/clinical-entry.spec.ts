...
describe('fechas de las entradas', () => {
  it('fecha larga con la hora de Argentina', () => {
    expect(formatEntryDate('2026-08-27T12:34:00.000Z')).toBe('27 de agosto de 2026 · 09:34');
  });

  // 00:30 UTC del 28 son las 21:30 del 27 en Argentina.
  it('no corre la fecha de noche', () => {
    expect(formatEntryShortDate('2026-08-28T00:30:00.000Z')).toBe('27 ago 2026');
  });
});
